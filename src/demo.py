...
<tr><td>Voice-cloning CER (80)</td><td>3.0%</td><td><b>0.9%</b></td></tr>
<tr><td>Voice-cloning SIM (80)</td><td>0.906</td><td><b>0.909</b></td></tr>
<tr><td>Reads numerals</td><td>yes</td><td>yes</td></tr>
</table>
<p class="note">VoxCPM2 already does Thai reasonably well. SiangTTS <b>matches the
base's speaker similarity</b> (SIM tied) and <b>substantially improves
intelligibility</b> (cloning CER ~3× lower). Listen below and judge for yourself.
Short/long sets are small (5 / 2 prompts); cloning is 80 prompts; CER via
Typhoon-Whisper.</p>
"""
