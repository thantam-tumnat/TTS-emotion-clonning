...
class BenchmarkService:
    ...
    def run_take(self, req: BenchmarkTakeRequest) -> BenchmarkTakeResult:
        ...
        try:
            ...
            # Always pinned on this pipeline: SeedVC converts every take to the
            # named target, so successive takes cannot come back as different
            # people the way an unconditioned VoxCPM2 take can.
            voice_anchor = "speaker" if req.speaker_id else "reference"
